                                ...
                                (
                                    <Paper style={styles.Paper} elevation={3}>
                                        <Box display="block" justifyContent="left" m={1} p={1}>
                                            <h2><strong>RUC: </strong>{data.user.ruc}</h2>
                                            <h2><strong>Nombre: </strong>{data.user.bussiness_name}</h2>
                                            <h2><strong>Descripción: </strong>{data.user.bussiness_description}</h2>
                                            <h2><strong>Dirección: </strong>{data.user.bussiness_address}</h2>
                                        </Box>
                                        <Button
                                ...
                                >
                                    <Grid container>
                                        <Grid xs={12} sm={12} md={12} lg={12}>
                                            ...
                                            />
                                            <TextField
                                                defaultValue={data.user.bussiness_name}
                                                id="bussiness_name"
                                                name="bussiness_name"
                                                variant="outlined"
                                                inputRef={register}
                                            ...
                                            />
                                            <TextField
                                                defaultValue={data.user.bussiness_description}
                                            ...
                                            />
                                            <TextField
                                                defaultValue={data.user.bussiness_address}
